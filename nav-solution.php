...
?>">
	...
	?>
		...
		<nav id="nav-main" class="nav-main" role="navigation"><!-- NAVIGATION -->
			<?php echo apply_filters( 'wmhook_skip_link_content_html', '<a class="invisible" href="#main-title" title="' . __( 'Skip to content', 'lespaul_domain' ) . '">' . __( 'Skip to content', 'lespaul_domain' ) . '</a>' ); ?>
			<div class="mobile-menu">
				<span class="wmicon-menu"><?php echo apply_filters( 'wmhook_navigation_mobile_text', __( 'Menu', 'lespaul_domain' ) ); ?></span>
			</div>
