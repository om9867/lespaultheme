...
<article class="main e-commerce">

	<?php do_action( 'wm_start_main_content' ); ?>

	<?php get_template_part( 'inc/loop/loop', 'startup' ); ?>
...
<section class="featured-mobile-app">
<div class="container">
<?php echo do_shortcode("[get-posts-app category='startup-app-portfolio']");  ?>
</div>
</section>
